	...
	ukayLayout(){
		...
		this.reRender(`<div align="center">
			 ...
			 <center>
					...
					<div class= "row" align="center">
						<div class="table-responsive col-md-4 col-md-offset-4"   >
							<div class="form-group"  >
								<label for="usr"><font color="#00cc99" font size=3><b>Enter First Name:</b></label>
								<input type="text" class="form-control" id="fname">
								<label for="usr" ><font color="#00cc99" font size=3 ><b>Enter Last Name:</b></label>
								<input type="text" class="form-control" id="lname">
								<label for="usr" ><font color="#00cc99" font size=3 ><b>Enter Address:</b></label>
			  ...
			  <div  align="center">
			  <button type="button" class="btn btn-success"  id="reg">Get Started</button>
			  </div>	
